...
#define FILTER 	0b00000010000										// only look at direction bit
#define MASK 	0b00000010000										// 11b id. Only look at Module bits [7..5] and direction (should be set to "from" = 1)
